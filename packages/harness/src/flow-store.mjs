// Canonical durable FLOW runtime state for the Harness.
// It deliberately depends only on Node built-ins and the public Vault surface,
// never on change/sensor/profile policy modules.
import {
  readFileSync, readdirSync,
} from 'node:fs';
import { join } from 'node:path';
import {
  assertVaultPathSafe, getLocale, mkdirVaultPath, VAULT_LOCK_BUSY,
  withVaultPathLock, writeVaultFileAtomic,
