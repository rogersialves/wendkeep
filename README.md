...
| **Contexto ativo** | `context switch`, transição causal de branch e rollback | [Contexto ativo](https://github.com/rogersialves/wendkeep/blob/main/docs/pt-BR/commands/context.md) |
